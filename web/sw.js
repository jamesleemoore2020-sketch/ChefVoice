const CACHE='chefvoice-pwa-v0.3.0';
const CORE=['./','./index.html','./css/styles.css','./js/app.js','./js/ingredient-parser.js','./js/cooking-session-parser.js','./js/voice-capture.js','./js/storage.js','./js/firebase-config.js','./js/firebase-client.js','./manifest.webmanifest','./assets/chefvoice-icon.png','./assets/chefvoice-cover.webp','./assets/community-hero.webp','./assets/live-hero.webp'];
